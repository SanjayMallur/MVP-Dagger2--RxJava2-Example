...
/**
 * {@link CommentsMvpPresenter -- to show comments data on UI after attaching view}
 * @author Sanjay Mallur
 */

public class CommentsMvpPresenter implements PostsDetailsContractor.CommentsMvpPresenter<PostsDetailsContractor.CommentsView> {
     ...
     */
    public CommentsMvpPresenter(@NonNull CommentsRepository commentsRepository) {
