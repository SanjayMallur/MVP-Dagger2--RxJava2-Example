...
/**
 * {@link PhotosMvpPresenter -- to show photos data on UI after attaching view}
 * @author Sanjay Mallur
 */

public class PhotosMvpPresenter implements PostsDetailsContractor.PhotosMvpPresenter<PostsDetailsContractor.PhotosView> {
     ...
     */
    public PhotosMvpPresenter(@NonNull PhotosRepository photosRepository){
